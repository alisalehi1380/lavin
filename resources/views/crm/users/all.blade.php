                                ...
                                <div class="card card-body filter">
                                    <form id="filter-form">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group justify-content-center col-6">
                                                <label for="name" class="control-label IRANYekanRegular">جنسیت</label>
                                        ...
                                        <div class="form-group col-12 d-flex justify-content-center mt-3">
                                            ...
                                            <script>
                                                function reset()
                                                {
                                                    ...
                                                    document.getElementById("sport_id-filter").selectedIndex = "0";
                                                    document.getElementById("league_id-filter").selectedIndex = "0";
                                                }
                                            </script>
                                                        ...
                                                        <div class="modal-dialog modal-xs">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <h5 class="IRANYekanRegular">آیا مطمئن هستید که میخواهید {{ $user->user }} را بازیابی نمایید؟</h5>
                                                                </div>
                                                        ...
                                                        <div class="modal-dialog modal-xs">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="row">
                                                                        <div class="col-6">
                                                                            <P class="IR">نام و نام خانوادگی: {{ $user->firstname  }}</p> 
                                                                        </div>
                                                                        <div class="col-6">
                                                                            <P class="IR">نام و نام خانوادگی: {{ $user->firstname  }}</p> 
                                                                        </div>
