                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row" style="margin-bottom: 20px;">
                                <div class="col-12">
                                    <div class="btn-group" >
                                        <a href="{{ route('admin.services.details.create',$service) }}" class="btn btn-sm btn-primary">
                                            <i class="fa fa-plus plusiconfont"></i>
                                            <b class="IRANYekanRegular">ایجاد جزئیات جدید</b>
                                        </a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                        ...
                                                        <div class="modal-dialog modal-xs">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <form action="{{ route('admin.services.details.recycle', [$service,$detail]) }}" method="POST" class="d-inline">
                                                                        @csrf
                                                                        @method('patch')
                                                ...
                                                @else
                                                    ...
                                                    <a class="font18 m-1" href="{{ route('admin.services.details.luck.create', [$service,$detail]) }}" title="افزودن به گردونه شانس">
                                                        <i class="fas fa-hockey-puck text-success"></i>
                                                    </a>

                                                    <a class="font18 m-1" href="{{ route('admin.services.details.images.show', [$service,$detail]) }}" title="تصاویر">
                                                        <i class="fas fa-images text-warning"></i>
                                                    </a>

                                                    <a class="font18 m-1" href="{{ route('admin.services.details.videos.show', [$service,$detail]) }}" title="ویدئوها">
                                                        <i class="fas fa-video text-primary"></i>
                                                    </a>

                                                    <a class="font18 m-1" href="{{ route('admin.services.details.edit',[$service,$detail]) }}" title="ویرایش">
                                                        ...
                                                        <div class="modal fade" id="remove{{ $detail->id }}" tabindex="-1" aria-labelledby="reviewLabel" aria-hidden="true">
                                                            <div class="modal-dialog modal-xs">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <form action="{{ route('admin.services.details.delete',[$service,$detail]) }}"  method="POST" class="d-inline">
                                                                            @csrf
                                                                            @method('DELETE')
