                ...
                <div class="col-12">
                    <div class="page-title-box">
                        <div class="page-title-right">
                            ...
                            {{ Breadcrumbs::render('services.detiles.videos.create',$detail) }}
                            </ol>
                        </div>
                        <h4 class="page-title">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="margin:auto">
                                ...
                                <form method="post" id="uploadform" action="{{ route('admin.details.videos.upload',$detail) }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row mt-2">
                                        <div class="col-6">
                                            <div class="fileupload btn btn-success waves-effect waves-light m-4">
