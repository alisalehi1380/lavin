                        ...
                        <div class="card-body">
                         ...
                         <div class="row" style="margin-bottom: 20px;">
                                <div class="col-12">
                                    ...
                                    <div class="btn-group" >
                                        <a href="{{ route('admin.details.videos.create',$detail) }}" class="btn btn-sm btn-primary">
                                                            ...
                                                            <div class="modal-dialog modal-xs">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <form action="{{ route('admin.details.videos.delete',[$detail,$video]) }}"  method="POST" class="d-inline">
                                                                            @csrf
                                                                            @method('DELETE')
