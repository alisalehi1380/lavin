                                ...
                                <div class="col-6 text-right">
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ route('admin.admins.create') }}" class="btn btn-sm btn-primary">
                                            ...
                                            <b class="IRANYekanRegular">افزودن پزشک جدید</b>
                                        </a>
                                    </div>
                                      @endif  
                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    ...
                                                    @if(Auth::guard('admin')->user()->can('admins.feilds.index')) 
                                                    ...
                                                    @if(Auth::guard('admin')->user()->can('admins.address.show')) 
