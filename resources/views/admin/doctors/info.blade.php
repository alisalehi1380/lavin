                ...
                <div class="col-12">
                    <div class="page-title-box">
                        <div class="page-title-right">
                            ...
                            {{ Breadcrumbs::render('doctors.info',$doctor) }}
                            </ol>
                        </div>
                        <h4 class="page-title">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="margin:auto">
                                ...
                                @if(Auth::guard('admin')->user()->can('doctors.video')) 
                                <div class="row">
                                    <div class="col-12  text-right">
                                        ...
                                        @if(Auth::guard('admin')->user()->can('doctors.video.upload') || Auth::guard('admin')->user()->can('doctors.video.store')) 
