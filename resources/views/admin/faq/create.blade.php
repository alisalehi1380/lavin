                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="margin:auto">
                                ...
                                <form class="form-horizontal" id="form" action="{{ route('admin.faq.store') }}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}

                                    <div class="row">
                                        <div class="col-12">
                                            <label for="question" class="control-label IRANYekanRegular">پرسش</label>
                                            <input type="text" class="form-control input" name="question" id="question" placeholder="پرسش  را وارد کنید" value="{{ old('question')  }}">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <textarea type="text" class="form-control input" name="answer" id="answer" placeholder="پاسخ  را وارد کنید">{{ old('answer')  }}</textarea>
                                    ...
                                    <div class="row mt-2 ">
                                        <div class="col-12" style="display:inherit;">
                                            <input type="radio" id="active" name="display" value="{{ App\Enums\Status::Active }}" @if(old('status')!=App\Enums\Status::Deactive) checked @endif>
                                            &nbsp;
                                            <label for="active">نمایش</label><br>
                                            &nbsp;&nbsp; &nbsp;
                                            <input type="radio" id="deactive" name="display" value="{{ App\Enums\Status::Deactive }}" @if(old('status')==App\Enums\Status::Deactive) checked @endif>
                                            &nbsp;
