...
<div class="content-page">
    ...
    <div class="content">
        ...
        <!-- start page title -->
                                            ...
                                            <article class="timeline-item timeline-item-left">
                                                <div class="timeline-desk">
                                                    <div class="timeline-box">
                                                        ...
                                                        <h4 class="mt-0 font-16 IRANYekanRegular">:پاسخ پشتیبان</h4>
                                                        ...
                                                        <hr>
                                                        <a href="{{ $message->attach }}" target="_blank" rel="download" title="فایل ضمیمه">
                                            ...
                                            <article class="timeline-item">
                                                <div class="timeline-desk">
                                                    <div class="timeline-box">
                                                        ...
                                                        @if($message->attach != null)
                                                        <hr>
                                                        <a href="{{ $message->attach }}" target="_blank" rel="download" title="فایل ضمیمه" class="font-22">
            ...
            @if(Auth::guard('admin')->user()->can('tickets.reply'))
            <div class="row">
                <div class="col-12">
                    <div class="card">
                            ...
                            <div class="container-fluid">
                                ...
                                <form class="form-horizontal" action="{{ route('admin.tickets.ticketmessage',$ticket) }}" method="post" enctype="multipart/form-data">
                                   {{ csrf_field() }}
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10 p-3">
                                         ...
                                         <div class="col-sm-2 p-3">
                                            <a  href="{{ route('admin.tickets.index') }}" class="btn btn-light border border-secondary cursor-pointer" title="بازگشت">
