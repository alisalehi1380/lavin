                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0 IR">
                                {{ Breadcrumbs::render('leveles.create') }}
                            </ol>   
                        </div>
                        <h4 class="page-title">
                            ...
                            <form method="POST" action="{{ route('admin.levels.store') }}">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        ...
                                        <input id="title" type="text" class="form-control  @error('name') is-invalid @enderror" name="title" value="{{ old('title') }}"  autofocus placeholder="عنوان">
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <input id="point" type="number" class="form-control text-center  @error('point') is-invalid @enderror" name="point" value="{{ old('point') }}"  autofocus placeholder="امتیاز">
