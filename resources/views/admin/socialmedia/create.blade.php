                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0 IR">
                                {{ Breadcrumbs::render('socialmedia.create') }}
                            </ol>
                        </div>
                        <h4 class="page-title">
                            <i class="fab fa-instagram page-icon"></i>
                             ایجاد شکبه اجتماعی جدید
                        </h4>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="margin:auto">
                                ...
                                <form class="form-horizontal" action="{{ route('admin.socialmedia.store') }}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <input type="text" class="form-control input" name="link" id="link" placeholder="لینک را وارد کنید" value="{{ old('link') }}">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <input type="text" class="form-control input" name="icon" id="icon" placeholder="آیکن را وارد کنید" value="{{ old('icon') }}">
