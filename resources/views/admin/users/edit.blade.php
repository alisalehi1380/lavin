                            ...
                            <form method="POST" action="{{ route('admin.users.update',$user) }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="introduced" type="text" class="form-control @error('nationcode') is-invalid @enderror ltr"  name="nationcode" value="{{ old('nationcode') ?? $user->nationcode }}"   placeholder="کد ملی">
