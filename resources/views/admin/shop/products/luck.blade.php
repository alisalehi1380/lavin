        ...
        <!-- start page title -->
                ...
                <div class="col-12">
                    <div class="page-title-box">
                        <div class="page-title-right">
                            ...
                            {{ Breadcrumbs::render('products.luck') }}  
                            </ol>
                        </div>
                        <h4 class="page-title">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="form-horizontal" id="form" action="{{ route('admin.shop.products.luck.store',$Product) }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="row">
