                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="margin:auto">
                                ...
                                <form class="form-horizontal" action="{{ route('admin.shop.products.store') }}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}

                                    <div class="row">
                                        <div class="col-12">
                                            <label for="name" class="control-label IRANYekanRegular">نام محصول</label>
                                            <input type="text" class="form-control input" name="name" id="name" placeholder="نام محصول را وارد کنید" value="{{ old('name') }}">
                                    ...
                                    <div class="row  mt-2">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <input type="text" class="form-control input text-right" name="stock" id="stock" placeholder="موجودی را وارد کنید" value="{{ old('stock') }}">
                                    ...
                                    <div class="row  mt-2">
                                        <div class="col-12 col-md-2">
                                            <div class="custom-control custom-checkbox mt-4">
                                                <input type="checkbox" class="custom-control-input" id="special" name="special" {{ old('special')=='on'?'checked':'' }}>
                                        ...
                                        <div class="col-12 col-md-5">
                                            ...
                                            <input type="text" class="form-control text-center" id="specialDateTime" name="specialDateTime" value="{{ old('specialDateTime') }}"  readonly>
                                        ...
                                        <div class="col-12 col-md-5">
                                            ...
                                            <input id="specialPrice" type="text" class="form-control  @error('specialPrice') is-invalid @enderror text-right" name="specialPrice" value="{{ old('specialPrice') }}"  autofocus placeholder="قیمت ویژه (تومان):">
                                    ...
                                    <div class="row my-2">
                                        <div class="col-sm-12">
                                            <label for="description" class="control-label IRANYekanRegular">توضیحات</label>
                                             <textarea class="form-control" row="100" class="form-control" name="description" id="description" placeholder="توضیحات...">{{ old('description') }}</textarea>
