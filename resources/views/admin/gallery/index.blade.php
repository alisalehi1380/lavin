                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        @endif
                           ...
                           @if(Auth::guard('admin')->user()->can('gallery.store'))
                            <div class="row">
                                <div class="col-12">
                                ...
                                <div class="col-sm-6 col-xl-3 filter-item all web illustrator">
                                    <div class="gal-box">
                                        ...
                                        <div class="gall-info">
                                            ...
                                            @if(Auth::guard('admin')->user()->can('gallery.images.index'))
                                            ...
                                            @if(Auth::guard('admin')->user()->can('gallery.update'))
                                            ...
                                            @if(Auth::guard('admin')->user()->can('gallery.destroy'))
