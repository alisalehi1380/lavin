                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0 IR">
                              {{ Breadcrumbs::render('services.cat') }}
                            </ol>
                        </div>
                        <h4 class="page-title">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row" style="margin-bottom: 20px;">
                                ...
                                <div class="col-6 text-right">
                                    ...
                                    <div class="btn-group" >
                                        <a href="{{ route('admin.services.categories.create') }}" class="btn btn-sm btn-primary">
                                ...
                                <table id="tech-companies-1" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if(Auth::guard('admin')->user()->can('services.categories.sub.index'))
                                                <a class="font18 mx-2" href="{{ route('admin.services.categories.sub.index', $category) }}" title="زیر دسته ها">
                                                    <i class="fas fa-layer-group text-warning"></i>
                                                </a>
                                                @endif

                                                @if(Auth::guard('admin')->user()->can('services.categories.edit'))
                                                <a class="font18 mx-2" href="{{ route('admin.services.categories.edit', $category) }}" title="ویرایش">
                                                    <i class="fa fa-edit text-info"></i>
                                                </a>
                                                @endif

                                                @if(Auth::guard('admin')->user()->can('services.categories.delete'))
                                                    ...
                                                    <div class="modal-dialog modal-xs">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form action="{{ route('admin.services.categories.delete', $category) }}"  method="POST" class="d-inline">
                                                                    @csrf
                                                                    @method('DELETE')
