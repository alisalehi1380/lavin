                ...
                <div class="col-12">
                    <div class="page-title-box">
                        <div class="page-title-right">
                            ...
                            {{ Breadcrumbs::render('services.cat.sub',$parent) }}
                            </ol>
                        </div>
                        <h4 class="page-title">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row" style="margin-bottom: 20px;">
                                ...
                                <div class="col-6 text-right">
                                     @if(Auth::guard('admin')->user()->can('services.categories.sub.create'))
                                        <div class="btn-group" >
                                            <a href="{{ route('admin.services.categories.sub.create',$parent) }}" class="btn btn-sm btn-primary">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                             ...
                                             @if(Auth::guard('admin')->user()->can('services.categories.sub.edit'))
                                              <a class="font18 mx-2" href="{{ route('admin.services.categories.sub.edit',[$parent,$category]) }}" title="ویرایش">
                                                <i class="fa fa-edit text-info"></i>
                                              </a>
                                              @endif

                                               
                                              @if(Auth::guard('admin')->user()->can('services.categories.sub.delete'))
                                                    ...
                                                    <div class="modal-dialog modal-xs">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form action="{{ route('admin.services.categories.sub.delete',[$parent,$category]) }}"  method="POST" class="d-inline">
                                                                    @csrf
                                                                    @method('DELETE')
