                ...
                <div class="col-12">
                    <div class="page-title-box">
                        <div class="page-title-right">
                            ...
                            {{ Breadcrumbs::render('services.detiles.luck',$service,$detail) }}
                            </ol>
                        </div>
                        <h4 class="page-title">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="form-horizontal" id="form" action="{{ route('admin.services.details.luck.store',[$service,$detail]) }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="row">
