        ...
        <!-- start page title -->
                ...
                <div class="col-12">
                    <div class="page-title-box">
                        <div class="page-title-right">
                            ...
                            {{ Breadcrumbs::render('services.detiles.images',$service,$detail) }}
                            </ol>
                        </div>
                        <h4 class="page-title">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                             @if(Auth::guard('admin')->user()->can('services.details.images.store'))
                            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="margin:auto">

                                <form class="form-horizontal" action="{{ route('admin.services.details.images.store',[$service,$detail]) }}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="row m-1">
                                                ...
                                                <div class="col-6 text-right">
                                                     @if(Auth::guard('admin')->user()->can('services.details.images.delete'))
                                                            ...
                                                            <div class="modal-dialog modal-xs">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <form action="{{ route('admin.services.details.images.delete',[$service,$detail,$image]) }}"  method="POST" class="d-inline">
                                                                            @csrf
                                                                            @method('DELETE')
