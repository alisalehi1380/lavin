...
class Zarinpal
{
    ...
    private function zarinpal_node()
    {
        ...
        {
            $ir_ch = curl_init("https://sandbox/pg/services/WebGate/wsdl");
            ...
            $de_ch = curl_init("https://sandbox/pg/services/WebGate/wsdl");
            ...
            if (function_exists('fsockopen'))
            {
                ...
                $de_domain 	= "https://sandbox/pg/services/WebGate/wsdl";
                $ir_domain 	= "https://sandbox/pg/services/WebGate/wsdl";
                ...
                $webservice = "https://sandbox/pg/services/WebGate/wsd";
